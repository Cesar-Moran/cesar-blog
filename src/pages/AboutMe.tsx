...
export default function AboutMe() {
  return (
    <section className="container flex justify-center items-center w-full ">
      <h1 className=" uppercase absolute  cursor-default -left-20  lg:-left-28  -rotate-90 text-5xl lg:text-6xl border-b-2 bg-gradient-to-r from-blue-500 to-gray-900 bg-clip-text text-transparent ">
        About me
      </h1>
      <div className=" p-8 space-y-4 backdrop-blur   rounded-lg   border border-gray-400 dark:border-gray-50 bg-white/5   shadow-lg">
        ...
        <p className="max-w-xl text-md tracking-normal text-slate-500 font-medium">
          {" "}
